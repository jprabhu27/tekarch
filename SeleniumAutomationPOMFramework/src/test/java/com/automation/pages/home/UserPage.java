...
public class UserPage extends BasePage {
	...
	public WebDriver clickEditProfile() {
		...
		try
		{
			...
			report.logTestInfo("Edit profile popup window is displayed");
		}
		catch(NoSuchFrameException e)
		{
			report.logTestInfo("Edit profile popup window is not displayed");
			throw e;
		}
	...
	public void postMessage(String message) {
		...
		report.logTestInfo("Posted message: " + message);
	}
	...
	public void uploadFile(String filePath) {
		...
		report.logTestInfo("Uploaded file: " + filePath);
	}
	...
	public void uploadProfilePhoto(String filePath) {
		...
		report.logTestInfo("Uploaded profile photo: " + filePath);
	}
}
