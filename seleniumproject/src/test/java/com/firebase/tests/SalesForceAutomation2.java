...
public class SalesForceAutomation2 extends BaseTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String appPropertiesFilePath = System.getProperty("user.dir") + "\\src\\test\\resources\\\\applicationData.properties";
		//String appPropertiesFilePath = "C:/Jaya/JAVA BASICS/seleniumproject/src/test/resources";
...
//		alertText
	...
	public static void createAccountReport_14_testcase(Properties props) {
		...
		WebElement activity = driver.findElement(By.xpath("//*[@id=\"toolsContent\"]/tbody/tr/td[1]/div/div/div[1]/ul/li[2]/a"));
		activity.click();
